...
Again, this is not a critique of certs. In low-security, ephemeral contexts where costs can't be amortized, one jurisdiction is normative, and existing tools are the only option, certs can be a great choice. But given today's cybertrust issues and globalization, such contexts are becoming rarer, and certs should, too. It's time for newer tech (same tried-and-true cryptographic primitives, just packaged more powerfully) to play a primary role.
...
[As of year-end 2021](https://www.prweb.com/releases/2022/9/prweb18894322.htm), "good will" (the value of public reputation and brand) on the balance sheets of the S&amp;P 500 reached a five-year high of 3.77 trillion USD — an average of 8.5 billion USD per company. Is it wise to protect permanent org identity and its associated reputation with single secrets? Is it okay to know almost nothing about who holds the secrets, what triggered their rotation, or how the mechanics of rotation were secured?
...
## Maintenance is hard to do well
