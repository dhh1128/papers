...
This is more than just noticing boundaries when we trip over them. "Recognize" implies that we proactively seek to understand what boundaries exist, and where, and why &mdash; and that we accept them and acknowledge to ourselves and others what we discover. Pretending that boundaries do not exist, or being casual and careless about them, can be dangerous, unethical, inefficient, or downright stupid. [Related: [Principle of Least Astonishment](https://usertimes.io/2018/12/07/the-principle-of-least-astonishment/) &vert; [Principle of Least Privilege](https://www.cloudflare.com/learning/access-management/principle-of-least-privilege/) &vert; [Boundaries in Personal Relationships](https://thementalmastery.com/the-psychology-of-boundaries-how-to-define-communicate-and-maintain-them-3-steps/) &vert; [#MeToo and Consent Boundaries](https://www.ipu-berlin.de/en/crossing-sexual-boundaries-and-drawing-moral-boundaries-metoo/) &vert; [Understood and Informed Consent in Bioethics](https://pmc.ncbi.nlm.nih.gov/articles/PMC5718441/) &vert; [Privacy by Design](https://digitalprivacy.ieee.org/publications/topics/what-is-privacy-by-design-and-why-it-s-important/) &vert; [Cognitive Load Theory](https://www.sciencedirect.com/science/article/abs/pii/0364021388900237) &vert; [Proportionality Principle in Law](https://lawforeverything.com/doctrine-of-proportionality-in-law/)]
...
A corollary to this principle is also worth mentioning: *Don't imagine boundaries where they don't actually exist.* Pretending that we don't know the user's intent can add annoying and unnessary friction. If we know, let's make it so, ASAP. [Related: [DRY Principle](https://medium.com/design-bootcamp/dry-vs-wet-patterns-in-ux-design-e0ff4d1fd2ac) &vert; [Single Source of Truth](https://martinfowler.com/articles/design-token-based-ui-architecture.html) &vert; [Frustration Aggression Hypothesis](https://www.simplypsychology.org/frustration-aggression-hypothesis.html) &vert; [Cognitive Friction](https://www.interaction-design.org/literature/topics/cognitive-friction)]

Of course there are times when confirmation is appropriate; unintended consequences are a risk. I appreciate having to click a final *Pay Now* button to book a $2000 plane ticket, and I'm glad GitHub asks me to type the name of the repo before I delete it. But how many times have you clicked an *Unsubscribe* link in email, only to arrive at a screen that asks you to re-enter your email address or confirm again? There is no legitimate intent boundary between clicking *Unsubscribe* and unsubscribing...
